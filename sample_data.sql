...
INSERT INTO keywords (keyword_id, base_keyword, global_emotion_score, first_registered, last_accessed, lifecycle_status, semantic_vector)
VALUES 
('KW-0001', '猫', 75, '2024-12-01 10:00:00', '2025-01-23 13:00:00', 'active', X'0001...'),  -- 実際のベクトルデータはバイナリで格納
('KW-0002', '雨', 45, '2024-12-01 10:30:00', '2025-01-22 15:30:00', 'active', X'0002...'),
('KW-0003', '公園', 65, '2024-12-02 09:15:00', '2025-01-23 10:20:00', 'active', X'0003...');
...
INSERT INTO metadata (meta_id, interp_id, creation_info, usage_history, version_log, reference_integrity)
VALUES
('META-0001', 'INT-0001',
'{
  "createdBy": "system",
...
INSERT INTO audit_logs (log_id, meta_id, event_time, event_type, user_role, before_state, after_state)
VALUES
